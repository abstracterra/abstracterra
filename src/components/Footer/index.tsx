        ...
        <Container>
          <Row justify="space-between">
            <Col lg={11} md={11} sm={12} xs={24}>
              <h1>Want to join the Abstracterra?</h1>
              <p>Join the Abstracterra community portal and be ready for some Abstract drops and upcoming events</p>
            </Col>
            <Col lg={11} md={11} sm={12} xs={24}>
            <div id="discord-button">
              <a href="https://discord.gg/rDYp2mC44A" target="_blank">
                <div className="icon">
      ...
      <Extra>
        <Container border={true}>
          ...
          >
            ...
            <FooterContainer>
              <SocialLink
                href="https://twitter.com/AbstracTerra"
                src="twitter.svg"
              />
