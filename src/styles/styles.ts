...
export const Styles = createGlobalStyle`
    ...
    textarea {
        ...
        :focus-within {
            background: none;
            box-shadow: #db2871 0px 0px 0px 1px;
        }
    }
    ...
    *:focus {
    ...
    :root {
        ...
        --charizard1: #fac;
        --charizard2: #ddccaa;
        --charizardfront: url(https://i.ibb.co/gP79FWt/1199.png);
        --pika1: #54a29e;
        --pika2: #a79d66;
      ...
      .timeline-event:hover .timeline-event-thumbnail {
        -moz-box-shadow: inset 40em 0 0 0 #db2871;
        -webkit-box-shadow: inset 40em 0 0 0 #db2871;
        box-shadow: inset 40em 0 0 0 #db2871;
      }
